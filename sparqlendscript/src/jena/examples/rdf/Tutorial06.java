...
public class Tutorial06 extends Object {
    ...
    static final String outputFileName = "out.rdf";
    ...
    public static void main (String args[]) throws Exception {
        ...
        model.createResource(vcard); // Overwrite resource

        String fileName = "C://apache-jena-ontology-inference-api/src/out.rdf";
