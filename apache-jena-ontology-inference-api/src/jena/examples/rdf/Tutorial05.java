...
public class Tutorial05 extends Object {
    ...
    /**
        ...
        subsequent examples.
    */    
    static final String inputFileName  = "rows.rdf"; // il file è dentro src
    ...
    public static void main (String args[]) {
        ...
        model.read(in, "");
//        model = FileManager.get().loadModel("C:/Users/valer/Desktop/progetto TSI/rows.rdf"); // ALTERNATIVA CON PATH
